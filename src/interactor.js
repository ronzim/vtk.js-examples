/**
 * Need to override interactorStyleImage since wwwl controls do not work with mpr
 * Fixed avoid check on image number (always -1 !) at line 237
 */
...
function vtkInteractorStyleImage(publicAPI, model) {
  ...
  publicAPI.windowLevel = (renderer, position) => {
    console.log("wwwl", model.currentImageProperty);
    ...
    if (model.currentImageProperty) {
      ...
      console.log("set", newWindow, newLevel);
